...
OUTPUT_BASEPATH="/mmu_nlp_hdd/zhengxue/Megatron-DeepSpeed/output0104_mpi_tp${TOP_K}_ep${EP_SIZE}"
...
if [ "${DEBUG}" = "true" ] || [ "${RDMA}" = "false" ]; then
    ...
    python /nlp_group/zhengxue/LLM/Pretrain/Codes/Megatron-DeepSpeed/pretrain_gpt.py --master-addr ${MY_NODE_IP}:39753 ${megatron_options} ${data_options} ${deepspeed_options} \
